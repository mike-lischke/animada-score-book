...
export const createAudioBufferPlayer = (audioBuffer: AudioBuffer, audioContext: AudioContext,
    time = 0): AudioBufferPlayer => {
    ...
    return {
        ...
        onEnded: callback => {
            sourceNode.addEventListener("ended", callback);
        }
    };
};
