...
import { useArrangementAndTracksSubscription } from "../../../ui/hooks/useArrangementAndTracksSubscription.js";
            ...
            <Overlay name="clear_tracks">
                <div style={{
                    ...
                    <button
                        className="push-button"
                        onClick={() => {
                            edit({ type: "EditCommand_ArrangementClear", arrangement, command: "clear all tracks" });
