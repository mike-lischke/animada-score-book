...
import { ComponentChild, createRef, type CSSProperties } from "preact";
import { createPortal } from "preact/compat";

import { ComponentPlacement, UIComponent, type ICommonUIProperties } from "./UIComponent.js";
...
interface ITooltipProviderProperties extends ICommonUIProperties {
...
export class TooltipProvider extends UIComponent<ITooltipProviderProperties, ITooltipProviderState> {
    ...
    public render(): ComponentChild {
        ...
        if (language === "json") {
            content = <Label code>{tooltip}</Label>;
        }
